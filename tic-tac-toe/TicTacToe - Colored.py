...
def title():
    '''GAME TITLE'''
    print('\n'*100)
    print('\033[1;32;1mX O X',' '*11,'O X O')
    print('O X O','\033[1;36;1mTIC-TAC-TOE'+'\033[1;32;1m X O X')
    print('X O X',' '*11,'O X O')
    print('\n'*2)

def names():
    '''PLAYERS NAMES'''
    print('\033[1;1;1mThis is a game for two players,\nso bring your friend and we\'ll get started\n')
...
def introduction():
    ...
    print('\n')
    print('\033[1;32;1mWELCOME {} & {} !!!\n'.format(PLAYER[1].upper(),PLAYER[2].upper()))
    print('\033[1;1;1m{} controls marker {} and {} controls marker {}'.format(PLAYER[1],markers[1],PLAYER[2],markers[2]))
    ...
    while replay:
        ...
        if turns%2 == 0:
            if not win_check(board,markers[2]):
                print('\033[1;33;1m{}\033[1;1;1m your turn to play...'.format(PLAYER[1]))
                player1_choice(board)
                turns += 1
                print('\n' * 40)
                display_board(board)
            else:
                print('Bravo \033[1;32;1m{}\033[1;1;1m, you just won the game!!\n'.format(PLAYER[2]))
                game_on = replay()
                break
        # PLAYER2 TURN:
        if turns%2 != 0:
            if not win_check(board,markers[1]):
                print('\033[1;32;1m{}\033[1;1;1m your turn to play...'.format(PLAYER[2]))
        ...
        if full_board_check(board):
            print('Full Board. The game ends in \033[1;32;1mDRAW\033[1;1;1m ')
            game_on = replay()
            break
